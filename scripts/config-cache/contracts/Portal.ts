...
export interface BurnCompletedEventObject {
  id: string;
  crossChainID: string;
  to: string;
  amount: BigNumber;
...
export interface MetaRevertRequestEventObject {
  id: string;
  to: string;
}
export type MetaRevertRequestEvent = TypedEvent<
  [string, string],
  MetaRevertRequestEventObject
>;
...
export interface RevertBurnRequestEventObject {
  id: string;
  to: string;
}
export type RevertBurnRequestEvent = TypedEvent<
  [string, string],
  RevertBurnRequestEventObject
>;

export type RevertBurnRequestEventFilter =
  TypedEventFilter<RevertBurnRequestEvent>;

export interface RevertSynthesizeCompletedEventObject {
  id: string;
  to: string;
  amount: BigNumber;
  bridgingFee: BigNumber;
...
export type RevertSynthesizeCompletedEvent = TypedEvent<
  ...
  RevertSynthesizeCompletedEventObject
>;
