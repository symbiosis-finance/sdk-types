...
export interface SynthesisInterface extends utils.Interface {
  ...
  events: {
    ...
    "BurnRequestTON(bytes32,address,uint256,address,(int8,bytes32),uint256,address)": EventFragment;
...
export interface BTCSynthesizeCompletedEventObject {
  id: string;
  to: string;
  amount: BigNumber;
  serial: BigNumber;
...
export interface RevertBurnCompletedEventObject {
  id: string;
  to: string;
  amount: BigNumber;
  bridgingFee: BigNumber;
...
export type SynthesizeCompletedEvent = TypedEvent<
  ...
  SynthesizeCompletedEventObject
>;
...
export interface Synthesis extends BaseContract {
  ...
  filters: {
    ...
    "BurnRequestTON(bytes32,address,uint256,address,(int8,bytes32),uint256,address)"(
      id?: null,
      from?: string | null,
      chainID?: BigNumberish | null,
      revertableAddress?: string | null,
