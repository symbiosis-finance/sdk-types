...
export interface OmniPoolInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "dynamicFeeMaximum",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "dynamicFeePow",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "dynamicFeeThreshold",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getFeeCollected",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setFeeCounter",
    values: [string]
  ): string;
  encodeFunctionData(
...
export type AssetAddedEvent = TypedEvent<[string], AssetAddedEventObject>;
...
export interface NewAEventObject {
  value: BigNumber;
}
export type NewAEvent = TypedEvent<[BigNumber], NewAEventObject>;

export type NewAEventFilter = TypedEventFilter<NewAEvent>;

export interface NewDynamicFeeParametersEventObject {
  threshold: BigNumber;
...
export type NewDynamicFeeParametersEvent = TypedEvent<
  ...
  NewDynamicFeeParametersEventObject
>;

export type NewDynamicFeeParametersEventFilter =
  TypedEventFilter<NewDynamicFeeParametersEvent>;
...
export interface NewFeeCounterEventObject {
  newFeeCounter: string;
}
export type NewFeeCounterEvent = TypedEvent<[string], NewFeeCounterEventObject>;

export type NewFeeCounterEventFilter = TypedEventFilter<NewFeeCounterEvent>;

export interface NewFeeReceiverEventObject {
  _newFeeReceiver: string;
}
export type NewFeeReceiverEvent = TypedEvent<
  [string],
  NewFeeReceiverEventObject
>;

export type NewFeeReceiverEventFilter = TypedEventFilter<NewFeeReceiverEvent>;

export interface NewFeeToEventObject {
  addr: string;
}
export type NewFeeToEvent = TypedEvent<[string], NewFeeToEventObject>;

export type NewFeeToEventFilter = TypedEventFilter<NewFeeToEvent>;

export interface NewLPFeeEventObject {
  value: BigNumber;
}
export type NewLPFeeEvent = TypedEvent<[BigNumber], NewLPFeeEventObject>;

export type NewLPFeeEventFilter = TypedEventFilter<NewLPFeeEvent>;

export interface NewMaxSupplyEventObject {
  token: string;
  newMaxSupply: BigNumber;
}
export type NewMaxSupplyEvent = TypedEvent<
  [string, BigNumber],
  NewMaxSupplyEventObject
>;

export type NewMaxSupplyEventFilter = TypedEventFilter<NewMaxSupplyEvent>;

export interface NewMintFeeThresholdEventObject {
  value: BigNumber;
}
export type NewMintFeeThresholdEvent = TypedEvent<
  [BigNumber],
  NewMintFeeThresholdEventObject
>;

export type NewMintFeeThresholdEventFilter =
  TypedEventFilter<NewMintFeeThresholdEvent>;

export interface NewVeSISEventObject {
  newVeSIS: string;
}
export type NewVeSISEvent = TypedEvent<[string], NewVeSISEventObject>;
...
export interface OmniPool extends BaseContract {
  ...
  filters: {
    ...
    "NewFeeReceiver(address)"(
      _newFeeReceiver?: null
    ): NewFeeReceiverEventFilter;
